...
#ifndef _MULTINOMIALBOOL_H_
#define _MULTINOMIALBOOL_H_
...
class MultiNomialBool
{
  ...
  public:
    MultiNomialBool (AttributeCollection& ACinput, int SOHM, int SOSM, double delta, map<string, int>& coder,
      bool integerTokens, bool weightNorm, int NGrams, stringstream& fin);
    ~MultiNomialBool ();
